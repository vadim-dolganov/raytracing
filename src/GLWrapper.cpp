...
{
	const std::string vertexShaderSrc = readStringFromFile(EXTERNAL_SOURCES "/shaders/quad.vert");
	std::string fragmentShaderSrc = readStringFromFile(EXTERNAL_SOURCES "/shaders/rt.frag");
